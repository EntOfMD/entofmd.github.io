/* 
Started to change code to ES6 on 2018-05-20 15:33:36
*/
//BUDGET CONTROLLER
var budgetController = (() => {
    ...
    Expense.prototype.calcPercentage = function(totalIncome) {
        if (totalIncome > 0) {
            ...
            this.percentage = Math.round(
                (this.value / data.allItems.exp.length) * 100
            );
        } else {
            this.percentage = -1;
        }
    ...
    var calculateTotal = function(type) {
        ...
        data.allItems[type].forEach(function(e) {
            //this works for both exp and inc
            sum += e.value;
        });
...
var UIController = (function() {
    ...
    return {
        getinput: function() {
            return {
                //instead of repeating myself, this will loop for both inc and exp
                type: document.querySelector(DOMstrings.inputType).value,
                description: document.querySelector(DOMstrings.inputDescription)
                    .value,
                value: parseFloat(
                    document.querySelector(DOMstrings.inputValue).value
                ) //parseFloat converts string to floating integer
            };
        },
...
var controller = (function(budgetCtrl, UICtrl) {
    var setupEventListeners = function() {
        ...
        document.addEventListener('keypress', function(e) {
            //this makes sure when you hit 'ENTER', it enters the info.
